  ...
  describe('Add to date', () => {
    it('should add seconds to date', () => {
      ...
      expect(result).toStrictEqual(
        new Date(datetime.setSeconds(datetime.getSeconds() + 60))
      )
    })
    ...
    it('should add minutes to date', () => {
      ...
      expect(result).toStrictEqual(
        new Date(datetime.setMinutes(datetime.getMinutes() + 1))
      )
    })
    ...
    it('should add years to date', () => {
      ...
      expect(result).toStrictEqual(
        new Date(datetime.setFullYear(datetime.getFullYear() + 1))
      )
    })
  })
